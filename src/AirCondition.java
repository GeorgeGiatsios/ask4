public class AirCondition {
    ...
    static String manufacturername = " Toyotomi: ";
    static String devicename = " Umi Eco UTN/UTG-09AP: ";
    static String devicetype = " AirCondition: ";
    static String energyconsumption = " 3A+";
